...
def synchronize_folders(source_path, destination_path, logger_path):
    ...
    # We will start with synchrnoizing the internal directories in the two folders first.
    ...
    for directory in directories_to_delete:
        ...
        try:
            ...
            log(f"Failed to delete directory \"{directory_to_delete}\" in destination folder: {e}", logger_path)
    ...
    for directory in directories_to_create:
        ...
        try:
            ...
            log(f"Directory \"{directory_to_create}\" created in destination folder.", logger_path)
        except Exception as e:
            log(f"Failed to create directory \"{directory_to_create}\" in destination folder: {e}", logger_path)
    ...
    for file in files_to_modify:
        ...
        try:
            ...
            log(f"Failed to modify \"{destination_file}\" in destination folder: {e}", logger_path)
    ...
    for file in files_to_create - files_to_modify:
        ...
        try:
            ...
            log(f"Failed to create \"{destination_file}\" in destination folder: {e}", logger_path)
    ...
    for file in files_to_delete - files_to_modify:
        ...
        try:
            ...
            log(f"Failed to delete \"{destination_file}\" in destination folder: {e}", logger_path)
